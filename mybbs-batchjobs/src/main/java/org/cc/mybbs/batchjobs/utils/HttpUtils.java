...
public class HttpUtils {
     ...
     *          IO异常 
     */  
    public static byte[] doPost(String url, Map<String, String> params, String enc, boolean ignoreCookies){  
    ...
    public static byte[] doPost(String url, Map<String, String> params){  
    	return doPost(url, params, URL_PARAM_DECODECHARSET_UTF8, true);
    }
     ...
     *          IO异常 
     */  
    public static byte[] doGet(String url, Map<String, String> params, String enc, boolean ignoreCookies){  
    ...
    public static byte[] doGet(String url, Map<String, String> params){  
    	return doGet(url, params, URL_PARAM_DECODECHARSET_UTF8, true);
    }
